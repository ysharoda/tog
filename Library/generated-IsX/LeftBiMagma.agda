 ...
 module LeftBiMagma  where
  ...
  evalOp : ({A  : Set } (n  : Nat)  → ((LeftBiMagma A ) → ((Vec A n ) → ((OpLeftBiMagmaTerm n ) → A ))))
  ...
  evalOpE : ({A  : Set } (n  : Nat )  → ((LeftBiMagma A ) → ((Vec A n ) → ((OpLeftBiMagmaTerm2 n A ) → A ))))
  ...
  inductionOp : ((n  : Nat) (P  : ((OpLeftBiMagmaTerm n ) → Set ))  → (((fin  : (Fin n ))  → (P (v fin ) )) → (((x1 x2  : (OpLeftBiMagmaTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (opOL x1 x2 ) )))) → (((x1 x2  : (OpLeftBiMagmaTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (linvOL x1 x2 ) )))) → ((x  : (OpLeftBiMagmaTerm n ))  → (P x ))))))
  ...
  inductionOpE : ((n  : Nat ) (A  : Set ) (P  : ((OpLeftBiMagmaTerm2 n A ) → Set ))  → (((fin  : (Fin n ))  → (P (v2 fin ) )) → (((x1  : A )  → (P (sing2 x1 ) )) → (((x1 x2  : (OpLeftBiMagmaTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (opOL2 x1 x2 ) )))) → (((x1 x2  : (OpLeftBiMagmaTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (linvOL2 x1 x2 ) )))) → ((x  : (OpLeftBiMagmaTerm2 n A ))  → (P x )))))))
  ...
  stageOp : ((n  : Nat)  → ((OpLeftBiMagmaTerm n ) → (Staged (OpLeftBiMagmaTerm n ) )))
  ...
  stageOpE : ((n  : Nat ) (A  : Set )  → ((OpLeftBiMagmaTerm2 n A ) → (Staged (OpLeftBiMagmaTerm2 n A ) )))
