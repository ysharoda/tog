 ...
 module DoubleMonoid  where
  ...
  record IsDoubleMonoid (A  : Set ) (0ᵢ  : A ) (+  : (A  → (A  → A ))) (1ᵢ  : A ) (*  : (A  → (A  → A )))  : Set where
    constructor IsDoubleMonoidC
    field
      lunit_0ᵢ : ({x  : A }  → (+ 0ᵢ x ) ≡ x )
      runit_0ᵢ : ({x  : A }  → (+ x 0ᵢ ) ≡ x )
  ...
  record DoubleMonoid (A  : Set )  : Set where
    ...
    field
      ...
      1ᵢ : A 
      * : (A  → (A  → A ))
      isDoubleMonoid : (IsDoubleMonoid A 0ᵢ (+) 1ᵢ (*) ) 
  ...
  simplifyB : (DoubleMonoidTerm  → DoubleMonoidTerm )
  simplifyB (+L 0L x )  = x 
  ...
  simplifyOp : ((n  : Nat)  → ((OpDoubleMonoidTerm n ) → (OpDoubleMonoidTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpDoubleMonoidTerm2 n A ) → (OpDoubleMonoidTerm2 n A )))
