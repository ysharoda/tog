 ...
 module MultUnaryAntiDistribution  where
  ...
  record IsMultUnaryAntiDistribution (A  : Set ) (prim  : (A  → A )) (*  : (A  → (A  → A )))  : Set where
    constructor IsMultUnaryAntiDistributionC
    field
  ...
  record MultUnaryAntiDistribution (A  : Set )  : Set where
    ...
    field
      prim : (A  → A )
      * : (A  → (A  → A ))
      isMultUnaryAntiDistribution : (IsMultUnaryAntiDistribution A prim (*) ) 
