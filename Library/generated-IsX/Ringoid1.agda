 ...
 module Ringoid1  where
  ...
  record IsRingoid1 (A  : Set ) (*  : (A  → (A  → A ))) (+  : (A  → (A  → A ))) (1ᵢ  : A )  : Set where
    constructor IsRingoid1C
    field
  ...
  simplifyB : (Ringoid1LTerm  → Ringoid1LTerm )
  ...
  simplifyOp : ((n  : Nat)  → ((OpRingoid1OLTerm n ) → (OpRingoid1OLTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpRingoid1OL2Term2 n A ) → (OpRingoid1OL2Term2 n A )))
