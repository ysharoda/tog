 ...
 module PointedPlusMagma  where
  ...
  record IsPointedPlusMagma (A  : Set ) (+  : (A  → (A  → A ))) (e  : A )  : Set where
    constructor IsPointedPlusMagmaC
  ...
  record PointedPlusMagma (A  : Set )  : Set where
    ...
    field
      + : (A  → (A  → A ))
      e : A 
      isPointedPlusMagma : (IsPointedPlusMagma A (+) e ) 
  ...
  simplifyOp : ((n  : Nat)  → ((OpPointedPlusMagmaTerm n ) → (OpPointedPlusMagmaTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpPointedPlusMagmaTerm2 n A ) → (OpPointedPlusMagmaTerm2 n A )))
