 ...
 module AndDeMorgan  where
  ...
  simplifyB : (AndDeMorganTerm  → AndDeMorganTerm )
  ...
  simplifyOp : ((n  : Nat)  → ((OpAndDeMorganTerm n ) → (OpAndDeMorganTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpAndDeMorganTerm2 n A ) → (OpAndDeMorganTerm2 n A )))
