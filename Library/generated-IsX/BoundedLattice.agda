 ...
 module BoundedLattice  where
  ...
  record Hom (A1 A2  : Set ) (Bo1  : (BoundedLattice A1 )) (Bo2  : (BoundedLattice A2 ))  : Set where
    constructor HomC
    field
      hom : (A1 → A2)
  ...
  record RelInterp (A1 A2  : Set ) (Bo1  : (BoundedLattice A1 )) (Bo2  : (BoundedLattice A2 ))  : Set₁ where
  ...
  simplifyB : (BoundedLatticeTerm  → BoundedLatticeTerm )
  simplifyB (+L 0L x )  = x 
  ...
  simplifyOp : ((n  : Nat)  → ((OpBoundedLatticeTerm n ) → (OpBoundedLatticeTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpBoundedLatticeTerm2 n A ) → (OpBoundedLatticeTerm2 n A )))
  ...
  evalOp : ({A  : Set } (n  : Nat)  → ((BoundedLattice A ) → ((Vec A n ) → ((OpBoundedLatticeTerm n ) → A ))))
  ...
  evalOpE : ({A  : Set } (n  : Nat )  → ((BoundedLattice A ) → ((Vec A n ) → ((OpBoundedLatticeTerm2 n A ) → A ))))
  ...
  inductionOp : ((n  : Nat) (P  : ((OpBoundedLatticeTerm n ) → Set ))  → (((fin  : (Fin n ))  → (P (v fin ) )) → (((x1 x2  : (OpBoundedLatticeTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (*OL x1 x2 ) )))) → (((x1 x2  : (OpBoundedLatticeTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (+OL x1 x2 ) )))) → ((P 0OL ) → ((P 1OL ) → ((x  : (OpBoundedLatticeTerm n ))  → (P x ))))))))
  ...
  inductionOpE : ((n  : Nat ) (A  : Set ) (P  : ((OpBoundedLatticeTerm2 n A ) → Set ))  → (((fin  : (Fin n ))  → (P (v2 fin ) )) → (((x1  : A )  → (P (sing2 x1 ) )) → (((x1 x2  : (OpBoundedLatticeTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (*OL2 x1 x2 ) )))) → (((x1 x2  : (OpBoundedLatticeTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (+OL2 x1 x2 ) )))) → ((P 0OL2 ) → ((P 1OL2 ) → ((x  : (OpBoundedLatticeTerm2 n A ))  → (P x )))))))))
  ...
  *OL' x1 x2  = (*OL x1 x2 )
  ...
  stageOp : ((n  : Nat)  → ((OpBoundedLatticeTerm n ) → (Staged (OpBoundedLatticeTerm n ) )))
  ...
  *OL2' x1 x2  = (*OL2 x1 x2 )
  ...
  stageOpE : ((n  : Nat ) (A  : Set )  → ((OpBoundedLatticeTerm2 n A ) → (Staged (OpBoundedLatticeTerm2 n A ) )))
