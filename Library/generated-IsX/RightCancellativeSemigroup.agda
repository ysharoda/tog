 ...
 module RightCancellativeSemigroup  where
  ...
  record IsRightCancellativeSemigroup (A  : Set ) (op  : (A  → (A  → A )))  : Set where
    constructor IsRightCancellativeSemigroupC
    field
  ...
  record RightCancellativeSemigroup (A  : Set )  : Set where
    ...
    field
      op : (A  → (A  → A ))
      isRightCancellativeSemigroup : (IsRightCancellativeSemigroup A op ) 
