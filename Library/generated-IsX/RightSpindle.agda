 ...
 module RightSpindle  where
  ...
  simplifyB : (RightSpindleTerm  → RightSpindleTerm )
  ...
  simplifyOp : ((n  : Nat)  → ((OpRightSpindleTerm n ) → (OpRightSpindleTerm n )))
  simplifyOp _ (<|OL x1 x2 )  = (<|OL (simplifyOp _ x1 ) (simplifyOp _ x2 ) )
  
  simplifyOp _ (v x1 )  = (v x1 )
  
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpRightSpindleTerm2 n A ) → (OpRightSpindleTerm2 n A )))
