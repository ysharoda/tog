 ...
 module PointedSemigroup  where
  ...
  record IsPointedSemigroup (A  : Set ) (op  : (A  → (A  → A ))) (e  : A )  : Set where
    constructor IsPointedSemigroupC
    field
  ...
  simplifyB : (PointedSemigroupTerm  → PointedSemigroupTerm )
  ...
  simplifyOp : ((n  : Nat)  → ((OpPointedSemigroupTerm n ) → (OpPointedSemigroupTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpPointedSemigroupTerm2 n A ) → (OpPointedSemigroupTerm2 n A )))
