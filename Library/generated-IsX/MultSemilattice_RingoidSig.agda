 ...
 module MultSemilattice_RingoidSig  where
  ...
  record IsMultSemilattice_RingoidSig (A  : Set ) (*  : (A  → (A  → A ))) (+  : (A  → (A  → A )))  : Set where
    constructor IsMultSemilattice_RingoidSigC
    field
  ...
  record MultSemilattice_RingoidSig (A  : Set )  : Set where
    ...
    field
      * : (A  → (A  → A ))
      + : (A  → (A  → A ))
      isMultSemilattice_RingoidSig : (IsMultSemilattice_RingoidSig A (*) (+) ) 
