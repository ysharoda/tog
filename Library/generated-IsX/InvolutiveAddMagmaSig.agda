 ...
 module InvolutiveAddMagmaSig  where
  ...
  record IsInvolutiveAddMagmaSig (A  : Set ) (+  : (A  → (A  → A ))) (prim  : (A  → A ))  : Set where
    constructor IsInvolutiveAddMagmaSigC
  ...
  record InvolutiveAddMagmaSig (A  : Set )  : Set where
    ...
    field
      + : (A  → (A  → A ))
      prim : (A  → A )
      isInvolutiveAddMagmaSig : (IsInvolutiveAddMagmaSig A (+) prim ) 
