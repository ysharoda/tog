 ...
 module NonDistributiveAddPreSemiring  where
  ...
  record IsNonDistributiveAddPreSemiring (A  : Set ) (+  : (A  → (A  → A ))) (*  : (A  → (A  → A )))  : Set where
    constructor IsNonDistributiveAddPreSemiringC
    field
  ...
  record NonDistributiveAddPreSemiring (A  : Set )  : Set where
    ...
    field
      + : (A  → (A  → A ))
      * : (A  → (A  → A ))
      isNonDistributiveAddPreSemiring : (IsNonDistributiveAddPreSemiring A (+) (*) ) 
  ...
  simplifyB : (NonDistributiveAddPreSemiringTerm  → NonDistributiveAddPreSemiringTerm )
  ...
  simplifyOp : ((n  : Nat)  → ((OpNonDistributiveAddPreSemiringTerm n ) → (OpNonDistributiveAddPreSemiringTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpNonDistributiveAddPreSemiringTerm2 n A ) → (OpNonDistributiveAddPreSemiringTerm2 n A )))
