 ...
 module RightQuasiGroup  where
  ...
  record IsRightQuasiGroup (A  : Set ) (op  : (A  → (A  → A ))) (rinv  : (A  → (A  → A )))  : Set where
    constructor IsRightQuasiGroupC
    field
  ...
  record RightQuasiGroup (A  : Set )  : Set where
    ...
    field
      op : (A  → (A  → A ))
      rinv : (A  → (A  → A ))
      isRightQuasiGroup : (IsRightQuasiGroup A op rinv ) 
  ...
  evalOp : ({A  : Set } (n  : Nat)  → ((RightQuasiGroup A ) → ((Vec A n ) → ((OpRightQuasiGroupTerm n ) → A ))))
  ...
  evalOpE : ({A  : Set } (n  : Nat )  → ((RightQuasiGroup A ) → ((Vec A n ) → ((OpRightQuasiGroupTerm2 n A ) → A ))))
  ...
  inductionOp : ((n  : Nat) (P  : ((OpRightQuasiGroupTerm n ) → Set ))  → (((fin  : (Fin n ))  → (P (v fin ) )) → (((x1 x2  : (OpRightQuasiGroupTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (opOL x1 x2 ) )))) → (((x1 x2  : (OpRightQuasiGroupTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (rinvOL x1 x2 ) )))) → ((x  : (OpRightQuasiGroupTerm n ))  → (P x ))))))
  ...
  inductionOpE : ((n  : Nat ) (A  : Set ) (P  : ((OpRightQuasiGroupTerm2 n A ) → Set ))  → (((fin  : (Fin n ))  → (P (v2 fin ) )) → (((x1  : A )  → (P (sing2 x1 ) )) → (((x1 x2  : (OpRightQuasiGroupTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (opOL2 x1 x2 ) )))) → (((x1 x2  : (OpRightQuasiGroupTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (rinvOL2 x1 x2 ) )))) → ((x  : (OpRightQuasiGroupTerm2 n A ))  → (P x )))))))
  ...
  stageOp : ((n  : Nat)  → ((OpRightQuasiGroupTerm n ) → (Staged (OpRightQuasiGroupTerm n ) )))
  ...
  stageOpE : ((n  : Nat ) (A  : Set )  → ((OpRightQuasiGroupTerm2 n A ) → (Staged (OpRightQuasiGroupTerm2 n A ) )))
