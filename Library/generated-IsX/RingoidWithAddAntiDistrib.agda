 ...
 module RingoidWithAddAntiDistrib  where
  ...
  record IsRingoidWithAddAntiDistrib (A  : Set ) (+  : (A  → (A  → A ))) (prim  : (A  → A )) (*  : (A  → (A  → A )))  : Set where
    constructor IsRingoidWithAddAntiDistribC
    field
  ...
  record RingoidWithAddAntiDistrib (A  : Set )  : Set where
    ...
    field
      ...
      prim : (A  → A )
      * : (A  → (A  → A ))
      isRingoidWithAddAntiDistrib : (IsRingoidWithAddAntiDistrib A (+) prim (*) ) 
  ...
  evalOp : ({A  : Set } (n  : Nat)  → ((RingoidWithAddAntiDistrib A ) → ((Vec A n ) → ((OpRingoidWithAddAntiDistribTerm n ) → A ))))
  ...
  evalOpE : ({A  : Set } (n  : Nat )  → ((RingoidWithAddAntiDistrib A ) → ((Vec A n ) → ((OpRingoidWithAddAntiDistribTerm2 n A ) → A ))))
  ...
  inductionOp : ((n  : Nat) (P  : ((OpRingoidWithAddAntiDistribTerm n ) → Set ))  → (((fin  : (Fin n ))  → (P (v fin ) )) → (((x1 x2  : (OpRingoidWithAddAntiDistribTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (+OL x1 x2 ) )))) → (((x1  : (OpRingoidWithAddAntiDistribTerm n ) )  → ((P x1 ) → (P (primOL x1 ) ))) → (((x1 x2  : (OpRingoidWithAddAntiDistribTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (*OL x1 x2 ) )))) → ((x  : (OpRingoidWithAddAntiDistribTerm n ))  → (P x )))))))
  ...
  *OL' x1 x2  = (*OL x1 x2 )
  ...
  stageOp : ((n  : Nat)  → ((OpRingoidWithAddAntiDistribTerm n ) → (Staged (OpRingoidWithAddAntiDistribTerm n ) )))
  ...
  *OL2' x1 x2  = (*OL2 x1 x2 )
  ...
  stageOpE : ((n  : Nat ) (A  : Set )  → ((OpRingoidWithAddAntiDistribTerm2 n A ) → (Staged (OpRingoidWithAddAntiDistribTerm2 n A ) )))
