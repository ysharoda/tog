 ...
 module Loop  where
  ...
  record IsLoop (A  : Set ) (op  : (A  → (A  → A ))) (e  : A ) (linv  : (A  → (A  → A ))) (rinv  : (A  → (A  → A )))  : Set where
    constructor IsLoopC
    field
  ...
  record Loop (A  : Set )  : Set where
    ...
    field
      ...
      linv : (A  → (A  → A ))
      rinv : (A  → (A  → A ))
      isLoop : (IsLoop A op e linv rinv ) 
  ...
  simplifyOp : ((n  : Nat)  → ((OpLoopOLTerm n ) → (OpLoopOLTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpLoopOL2Term2 n A ) → (OpLoopOL2Term2 n A )))
