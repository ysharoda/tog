 ...
 module AssociativeNonDistributiveRingoid  where
  ...
  record IsAssociativeNonDistributiveRingoid (A  : Set ) (*  : (A  → (A  → A ))) (+  : (A  → (A  → A )))  : Set where
    constructor IsAssociativeNonDistributiveRingoidC
    field
  ...
  record AssociativeNonDistributiveRingoid (A  : Set )  : Set where
    ...
    field
      * : (A  → (A  → A ))
      + : (A  → (A  → A ))
      isAssociativeNonDistributiveRingoid : (IsAssociativeNonDistributiveRingoid A (*) (+) ) 
