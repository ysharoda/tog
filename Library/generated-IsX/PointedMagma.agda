 ...
 module PointedMagma  where
  ...
  record Hom (A1 A2  : Set ) (Po1  : (PointedMagma A1 )) (Po2  : (PointedMagma A2 ))  : Set where
    constructor HomC
    field
      hom : (A1 → A2)
  ...
  record RelInterp (A1 A2  : Set ) (Po1  : (PointedMagma A1 )) (Po2  : (PointedMagma A2 ))  : Set₁ where
  ...
  simplifyOp : ((n  : Nat)  → ((OpPointedMagmaTerm n ) → (OpPointedMagmaTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpPointedMagmaTerm2 n A ) → (OpPointedMagmaTerm2 n A )))
  ...
  evalOp : ({A  : Set } (n  : Nat)  → ((PointedMagma A ) → ((Vec A n ) → ((OpPointedMagmaTerm n ) → A ))))
  ...
  evalOpE : ({A  : Set } (n  : Nat )  → ((PointedMagma A ) → ((Vec A n ) → ((OpPointedMagmaTerm2 n A ) → A ))))
  ...
  inductionOp : ((n  : Nat) (P  : ((OpPointedMagmaTerm n ) → Set ))  → (((fin  : (Fin n ))  → (P (v fin ) )) → ((P eOL ) → (((x1 x2  : (OpPointedMagmaTerm n ) )  → ((P x1 ) → ((P x2 ) → (P (opOL x1 x2 ) )))) → ((x  : (OpPointedMagmaTerm n ))  → (P x ))))))
  ...
  inductionOpE : ((n  : Nat ) (A  : Set ) (P  : ((OpPointedMagmaTerm2 n A ) → Set ))  → (((fin  : (Fin n ))  → (P (v2 fin ) )) → (((x1  : A )  → (P (sing2 x1 ) )) → ((P eOL2 ) → (((x1 x2  : (OpPointedMagmaTerm2 n A ) )  → ((P x1 ) → ((P x2 ) → (P (opOL2 x1 x2 ) )))) → ((x  : (OpPointedMagmaTerm2 n A ))  → (P x )))))))
  ...
  stageOp : ((n  : Nat)  → ((OpPointedMagmaTerm n ) → (Staged (OpPointedMagmaTerm n ) )))
  ...
  stageOpE : ((n  : Nat ) (A  : Set )  → ((OpPointedMagmaTerm2 n A ) → (Staged (OpPointedMagmaTerm2 n A ) )))
