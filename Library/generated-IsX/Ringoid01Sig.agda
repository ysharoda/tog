 ...
 module Ringoid01Sig  where
  ...
  simplifyB : (Ringoid01SigTerm  → Ringoid01SigTerm )
  ...
  simplifyOp : ((n  : Nat)  → ((OpRingoid01SigTerm n ) → (OpRingoid01SigTerm n )))
  ...
  simplifyOpE : ((n  : Nat ) (A  : Set )  → ((OpRingoid01SigTerm2 n A ) → (OpRingoid01SigTerm2 n A )))
