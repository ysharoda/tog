...
module AntiAbsorbent   where
  ...
  evalOpB n An vars (opOL x1 x2) = ((op An) (evalOpB n An vars x1) (evalOpB n An vars x2))  
  ...
  evalOp n An vars (opOL2 x1 x2) = ((op An) (evalOp n An vars x1) (evalOp n An vars x2))  
