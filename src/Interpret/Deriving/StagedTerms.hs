module Interpret.Deriving.StagedTerms where

import Tog.Raw.Abs hiding (Open)

import Interpret.Utils.Functions (farity)
import Interpret.Utils.Bindings (hiddenBind) 
import Interpret.Utils.TUtils (Name_, mkName, mkQName, mkArg, exprArity, genVars, getConstrName)
import Interpret.Utils.Lenses
